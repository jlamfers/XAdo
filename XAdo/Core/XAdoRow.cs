...
namespace XAdo.Core
{
    ...
    /// </summary>
    public class XAdoRow : DynamicObject, IXAdoRow
    {
        internal class Meta
        {
        ...
        public XAdoRow(string[] columnNames, object[] values, Type[] types = null, IDictionary<string, int> index = null)
        {
        ...
        internal XAdoRow(Meta meta, object[] values)
        {
        ...
        public XAdoRow(IEnumerable<KeyValuePair<string,object>> other )
        {
            _columnNames = new List<string>();
            _values = new List<object>();
            _index = new Dictionary<string, int>();
        ...
        public void Add(string key, object value)
        {
            if (ContainsKey(key))
            {
                throw new XAdoException("key already exists");
            }
        ...
        private int GetOrdinal(string name, bool throwException = true)
        {
            ...
            throw new XAdoException("Column " + name + " does not exist.");
        }
