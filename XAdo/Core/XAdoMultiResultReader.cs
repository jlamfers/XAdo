...
namespace XAdo.Core
{
    public class XAdoMultiResultReader : IDisposable
    {
       ...
       private readonly bool _allowUnbindableFetchResults;
        ...
        internal XAdoMultiResultReader(IDataReader reader, IDbCommand command, bool allowUnbindableFetchResults, bool allowUnbindableMembers, IXAdoDataReaderManager dataReaderQuery)
        {
            _reader = reader;
            _command = command;
        ...
        internal XAdoMultiResultReader(IDataReader reader, IDbCommand command, IEnumerable<Delegate> factories, IXAdoDataReaderManager dataReaderQuery)
        {
           _reader = reader;
           _command = command;
