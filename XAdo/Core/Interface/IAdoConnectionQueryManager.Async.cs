...
namespace XAdo.Core.Interface
{
    public partial interface IAdoConnectionQueryManager
    {
        ...
        Task<AdoMultiResultReaderAsync> QueryMultipleAsync(IDbConnection cn, string sql, object param = null, IDbTransaction tr = null, int? commandTimeout = null, CommandType? commandType = null, bool allowUnbindableFetchResults = true, bool allowUnbindableMembers = false);
        Task<AdoMultiResultReaderAsync> QueryMultipleAsync(IDbConnection cn, string sql, IEnumerable<Delegate> factories, object param = null, IDbTransaction tr = null, int? commandTimeout = null, CommandType? commandType = null);
