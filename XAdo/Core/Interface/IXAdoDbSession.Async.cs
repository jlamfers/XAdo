...
{
    public partial interface IXAdoDbSession
    {
        ...
        Task<XAdoMultiResultReaderAsync> QueryMultipleAsync(string sql, object param = null,CommandType? commandType = null);
        Task<XAdoMultiResultReaderAsync> QueryMultipleAsync(string sql, IEnumerable<Delegate> factories,  object param = null, CommandType? commandType = null);
