...
namespace XAdo.Core.Impl
{
   public partial class AdoDataReaderManagerImpl
   {
      ...
      {
         Task<IEnumerable> ReadAllAsync(AdoDataReaderManagerImpl parent, IAdoGraphBinderFactory binderFactory, Func<object, object, object, object, object, object, object, object, object> factory, IDataReader reader, bool allowUnbindableFetchResults, bool allowUnbindableMembers);
      }

      private class GraphReaderHelperAsync<T1, T2, T3, T4, T5, T6, T7, T8, TResult> : IGraphReaderHelperAsync
      {
         public async Task<IEnumerable> ReadAllAsync(AdoDataReaderManagerImpl parent, IAdoGraphBinderFactory binderFactory, Func<object, object, object, object, object, object, object, object, object> factory, IDataReader reader, bool allowUnbindableFetchResults, bool allowUnbindableMembers)
         {
            var next = 0;
            const int index1 = 0;
         ...
         private static T BindTarget<T>(AdoDataReaderManagerImpl parent, IDataReader reader, int index, Func<IDataReader, T> binder)
         {
