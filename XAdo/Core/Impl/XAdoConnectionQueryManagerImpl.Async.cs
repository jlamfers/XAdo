...
{
    public partial class XAdoConnectionQueryManagerImpl
    {
       ...
       public virtual async Task<XAdoMultiResultReaderAsync> QueryMultipleAsync(IDbConnection cn, string sql,
            ...
            bool allowUnbindableFetchResults = true, bool allowUnbindableMembers = false)
        {
            ...
            try
            {
                ...
                var multiReader = new XAdoMultiResultReaderAsync(reader, cmd, allowUnbindableFetchResults,
       ...
       public virtual async Task<XAdoMultiResultReaderAsync> QueryMultipleAsync(IDbConnection cn, string sql, IEnumerable<Delegate> factories, object param = null,IDbTransaction tr = null, int? commandTimeout = null, CommandType? commandType = null)
       {
          if (cn == null) throw new ArgumentNullException("cn");
          if (sql == null) throw new ArgumentNullException("sql");
          ...
          try
          {
             ...
             reader =
                 await cmd.ExecuteReaderAsync(wasopen ? CommandBehavior.Default : CommandBehavior.CloseConnection);
             var multiReader = new XAdoMultiResultReaderAsync(reader, cmd, factories, _dataReaderManager);
             skipClose = true;
             return multiReader;
          }
          catch
