...
namespace XAdo.Core.Impl
{
   ...
   {
      public static IXAdoContextInitializer EnableGraphParameterObject(this IXAdoContextInitializer self)
      {
         self.BindSingleton<IXAdoCommandFactory, XAdoCommandFactoryImplEx>();
         return self;
      }
   }
}
