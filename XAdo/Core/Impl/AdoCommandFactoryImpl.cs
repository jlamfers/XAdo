...
{
    public class AdoCommandFactoryImpl : IAdoCommandFactory
    {
        private readonly IAdoParameterFactory _parameterFactory;

        public AdoCommandFactoryImpl(IAdoParameterFactory parameterFactory)
        {
        ...
        protected virtual IDictionary<string, IAdoParameter> AsAdoParameterDictionary(object target)
        {
