...
namespace XAdo.Core.Impl
{
   ...
   public class XAdoGraphBinderCompilerImpl : IXAdoGraphBinderCompiler
   {
      private class Key
      {
      ...
      private readonly IXAdoGraphBinderFactory 
         _graphBinderFactory;


      public XAdoGraphBinderCompilerImpl(IXAdoGraphBinderFactory graphBinderFactory)
      {
      ...
      {
         var m = typeof(IXAdoGraphBinderFactory).GetMethods().Single(x => x.Name == "CreateRecordBinder");
