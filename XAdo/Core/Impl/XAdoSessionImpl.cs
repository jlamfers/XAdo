...
namespace XAdo.Core.Impl
{
   ...
   //  both connection and transaction are created on first need (lazy)
    ...
    public partial class XAdoSessionImpl : IXAdoSession, IXAdoConnectionProvider, IXAdoSessionInitializer
    {
       ...
       private Lazy<IDbConnection> LazyConnection
        ...
        public XAdoSessionImpl(IXAdoConnectionFactory connectionFactory,IXAdoConnectionQueryManager connectionQueryManager, XAdoContext context,IXAdoClassBinder binder)
        {
        ...
        public virtual IXAdoSession Initialize(string connectionStringName, int? commandTimeout = null,
        ...
        public virtual IXAdoSession Initialize(string connectionString, string providerName, int? commandTimeout = null,
            bool keepConnectionOpen = false, bool allowUnbindableFetchResults = true,
            bool allowUnbindableMembers = false)
        {
        ...
        public XAdoContext Context { get; private set; }
       ...
       public virtual IXAdoSession AddSqlBatchItem(XAdoSqlBatchItem batchItem)
       {
          EnsureNotDisposed();
          var batch = _sqlBatch;
          EnsureSqlBatch();
