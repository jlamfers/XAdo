...
{
   public partial class XAdoSqlBatchImpl : IXAdoSqlBatch
   {
      private readonly IAdoSqlInterceptor _sqlInterceptor;

      private readonly List<XAdoSqlBatchItem>
         _commands = new List<XAdoSqlBatchItem>();

      public XAdoSqlBatchImpl(IAdoSqlInterceptor sqlInterceptor = null)
      {
         _sqlInterceptor = sqlInterceptor;
      }


      public virtual IXAdoSqlBatch Add(XAdoSqlBatchItem batchItem)
      {
