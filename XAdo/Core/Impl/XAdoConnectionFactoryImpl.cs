...
{
    public class XAdoConnectionFactoryImpl : IXAdoConnectionFactory
    {
        ...
        private IDbConnection CreateConnection(string connectionString, DbProviderFactory factory, bool openConnection = false)
        {
            ...
            try
            {
                ...
                if (cn == null)
                {
                    throw new XAdoException("Unable to create connection: CreateConnection() returned null.");
                }
            ...
            {
                throw new XAdoException("Unable to create connection from connection string: " + connectionString + " and provider factory: " + factory.GetType(), ex);
            }
        }
    }
}
