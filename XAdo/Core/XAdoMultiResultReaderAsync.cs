...
namespace XAdo.Core
{
    public class XAdoMultiResultReaderAsync
    {
        ...
        private readonly IXAdoDataReaderManager _dataReaderQuery;
       private Delegate[] _factories;

       internal XAdoMultiResultReaderAsync(IDataReader reader, IDbCommand command, bool allowUnbindableFetchResults, bool allowUnbindableMembers, IXAdoDataReaderManager dataReaderQuery)
        {
       ...
       public XAdoMultiResultReaderAsync(IDataReader reader, DbCommand command, IEnumerable<Delegate> factories, IXAdoDataReaderManager dataReaderQuery)
        {
           _reader = (DbDataReader)reader;
           _command = command;
