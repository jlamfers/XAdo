...
namespace XAdo.Core
{
   public class LRUCache2<TKey, TValue> : IDictionary<TKey, TValue>, IDisposable
   {
      ...
      private class CacheManager
      {
         ...
         public CacheManager(ConcurrentDictionary<TKey, LinkedListNode<KeyValuePair<TKey, TValue>>> dict, LinkedList<LinkedListNode<KeyValuePair<TKey, TValue>>> list, int capacity)
         {
            _dict = dict;
            _list = list;
            _capacity = capacity;
