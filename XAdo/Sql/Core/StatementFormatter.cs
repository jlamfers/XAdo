...
namespace XAdo.Sql.Core
{
   ...
   public static class StringExtension
   {
      ...
      public static void FormatSql(this string format, TextWriter writer, params Action<TextWriter>[] args)
      {
         Cache.GetOrAdd(format, f => new StatementFormatter(f)).Format(writer, args);
      }
      public static string FormatSql(this string format, params Action<TextWriter>[] args)
      {
