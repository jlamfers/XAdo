...
namespace XAdo
{
   ...
   public class XAdoContext
   {
      ...
      {
         private readonly XAdoContext _context;

         public ContextInitializer(XAdoContext context)
         {
            _context = context;
         }
      ...
      public XAdoContext(string connectionStringName)
      {
      ...
      public XAdoContext(Action<IXAdoContextInitializer> initializer, IXAdoClassBinder customClassBinder = null)
      {
         Items = new Dictionary<object, object>();
      ...
      private void Initialize(Action<IXAdoContextInitializer> initializer)
      {
         ...
         TryBindSingleton<IXAdoSessionFactory, XAdoSessionFactoryImpl>();
         ...
         TryBind<IXAdoSession, XAdoSessionImpl>();
      ...
      public virtual IXAdoSession CreateSession()
      {
         ...
         return ConnectionStringName != null
             ? GetInstance<IXAdoSessionFactory>().Create(ConnectionStringName, CommandTimeout, KeepConnectionAlive, AllowUnbindableFetchResults, AllowUnbindableProperties)
             : GetInstance<IXAdoSessionFactory>().Create(ConnectionString, ProviderName, CommandTimeout, KeepConnectionAlive, AllowUnbindableFetchResults, AllowUnbindableProperties);
      }
