...
namespace XAdo.Quobs.Sql
{
   public interface ISqlExecuter
   {
      ...
      IEnumerable<T> ExecuteQuery<T>(string sql, Func<IDataRecord,T> factory, IDictionary<string, object> args);
      IEnumerable<T> ExecuteQuery<T>(string sql, Func<IDataRecord, T> factory, IDictionary<string, object> args, string sqlCount, out long count);
   }
}
