...
namespace XAdo.Core.Impl
{
    public partial class AdoSessionImpl
    {
        ...
        {
            EnsureNotDisposed();
            return await _connectionQueryManager.QueryAsync<T>(LazyInitializedConnection, sql, param, _tr, _commandTimeout, commandType, _allowUnbindableFetchResults, _allowUnbindableProperties);
        }
        ...
        {
            EnsureNotDisposed();
            return await _connectionQueryManager.QueryMultipleAsync(LazyInitializedConnection, sql, param, _tr, _commandTimeout, commandType, _allowUnbindableFetchResults, _allowUnbindableProperties);
        ...
        {
            EnsureNotDisposed();
            return await _connectionQueryManager.QueryAsync(LazyInitializedConnection, sql, factory, param, _tr, _commandTimeout, commandType, _allowUnbindableFetchResults, _allowUnbindableProperties);
        }
