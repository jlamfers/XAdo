...
namespace XAdo.Quobs.Impl
{
   ...
   {
      protected QuobImpl(ISqlResource<TEntity> queryBuilder, QueryContext context) : base(queryBuilder, context)
      {
      }
      ...
      protected override QuobImpl SelfOrNew(QueryContext context, ISqlResource querybuilder = null)
      {
