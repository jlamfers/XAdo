...
namespace XAdo.Quobs.Interface
{
   public interface ISqlResource
   {
      ...
      ISqlResource Map<TEntity, TMap>(Expression<Func<TEntity, TMap>> toExpression);
      ...
      Func<IDataRecord, object> GetBinder(IXAdoSession session);
      Type GetEntityType(IXAdoSession session);
