...
namespace XAdo.Quobs.Linq
{
   ...
   public static class StringExtension
   {
      ...
      public static void FormatSqlStatement(this string format, TextWriter writer, params Action<TextWriter>[] args)
      {
         Cache.GetOrAdd(format, f => new StatementFormatter(f)).Format(writer, args);
      }
      public static string FormatSqlStatement(this string format, params Action<TextWriter>[] args)
      {
