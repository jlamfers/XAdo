...
{
   public class SqlPredicateGenerator : ExpressionVisitor, ISqlPredicateGenerator
   {
      ...
      public SqlPredicateGenerator(ISqlDialect dialect, string parameterPrefix="p_", bool noargs = false)
      {
