...
namespace XAdo.Quobs.Core
{
   public abstract class BaseQuob<T> : ICloneable, ISqlBuilder
   {
      ...
      protected BaseQuob(ISqlFormatter formatter, ISqlConnection executer, QueryChunks descriptor, List<DbSchemaDescriptor.JoinPath> joins, bool argumentsAsLiterals)
      {
      ...
      protected QueryChunks Descriptor { get; set; }
